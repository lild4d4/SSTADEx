...
if disp is None:
    raise RuntimeError("No se pudo crear el PCell 'pmos' de la libreria 'SG13_dev'")

top = ly.create_cell("TOP")
top.insert(pya.CellInstArray(disp.cell_index(), pya.Trans(x0, y0)))
...
output = output_dir / "current_mirror_gentest.gds"
ly.write(str(output))
