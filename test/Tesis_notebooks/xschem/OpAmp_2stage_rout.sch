...
device=resistor
m=1}
C {devices/vsource.sym} -50 60 0 0 {name=Vr value=0.9 savecurrent=false}
C {devices/res.sym} -50 -60 0 0 {name=Rr
value=1000
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} -50 0 2 0 {name=p10 sig_type=std_logic lab=vr}
